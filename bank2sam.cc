...
/*typedef set<ID_t> prntRedSet;
prntRedSet printedreads;
*/
...
class Sam_entry
{
	...
	public:
		...
		/*Sam_entry(string id, int f, string ref_name, int p, int mq, string cig, string rnext, int pnext, int tlen, string s, string q)
		{
			read_id = id;
			flag = f;
			r_name = ref_name;
...
void PrintHelp ()
{
  ...
  cerr << ".DESCRIPTION.\n"
       << "  This program takes an AMOS bank directory and dumps its content \n"
